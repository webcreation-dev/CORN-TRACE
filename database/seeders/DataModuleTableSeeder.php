...
class DataModuleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Stockage::create([
            ...
            'Séchage_du_maïs_sur_le_sol_Yes'  => 0,
            'Égrenage_du_maïs_humide_Yes'  => 0,
            'Mode_de_traitement_Maize_stovers_stacked_in_heaps'  => 0,
            'Sacs_en_toile_Yes'  => 1,
            'Sacs_à_photos_Yes'  => 0,
            'Chaume_du_grenier_Yes'  => 0,
            'Grenier_Tôle_dacier_Yes'  => 0,
            'Bacs_étanches_Yes'  => 0,
            'Stockage_hermétique_Yes'  => 0,
            'Stocker_les_sacs_sur_le_sol_Yes'  => 1,
            'Sécher_les_grains_sur_une_bâche_Yes'  => 0,
            'Grains_sèches_sur_toit_de_terre_nue_Yes'  => 0,
            'Grains_de_qualité_Yes'  => 0,
            'Stocker_les_sacs_sur_des_palettes_en_bois_Yes'  => 0,
            'Type_de_stockage'  => 0.114049128522,
            'Séchage'  => 0.199195971398,
            'Décorticage'  => 0.253038663328,
            'Mode_de_conservation'  => 0.190645642701,
            'Jours' => 30,
            'other_observations'  => 'other_observations',
        ]);
    }
